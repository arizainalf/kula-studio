...
INSERT INTO users (email, password_hash, name, role, is_active, plan_tier, expires_at, youtube_url, phone) VALUES
  ('admin@dev.local',  's1$kIeyQK0OOX79vXAWZqrsPg$uEJkpx4Hm6-1WtP_gr4-HiVUnFBhjRR-HfrjIROa3L4', 'Admin Dev',  'admin_studio',   true,  NULL,        NULL, NULL, NULL),
  ('boss@dev.local',   's1$kIeyQK0OOX79vXAWZqrsPg$uEJkpx4Hm6-1WtP_gr4-HiVUnFBhjRR-HfrjIROa3L4', 'Manager Dev','manager', true,  NULL,        NULL, NULL, NULL),
  ('hadi@dev.local',   's1$kIeyQK0OOX79vXAWZqrsPg$uEJkpx4Hm6-1WtP_gr4-HiVUnFBhjRR-HfrjIROa3L4', 'Hadi PT',    'pt',      true,  'standard',  CURRENT_DATE + 30, 'https://www.youtube.com/watch?v=aclHkVaku9U', '6287884241516'),
  ('expi@dev.local',   's1$kIeyQK0OOX79vXAWZqrsPg$uEJkpx4Hm6-1WtP_gr4-HiVUnFBhjRR-HfrjIROa3L4', 'Expired PT', 'pt',      true,  'pro',       CURRENT_DATE - 2, NULL, NULL);
